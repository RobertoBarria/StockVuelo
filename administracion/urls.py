...
urlpatterns = [
    ...
    path('productos/<int:pk>/eliminar/', views.eliminar_producto_base, name='eliminar_producto_base'),
    ...
    path('productos/movimientos/exportar/', views.exportar_movimientos_excel, name='exportar_movimientos_excel'),
